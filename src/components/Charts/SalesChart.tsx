...
export const SalesChart = () => {
  ...
  const addMockData = () => {
    const mockData = [
      { name: 'Jan', amount: 120.50 },
      { name: 'Feb', amount: 160.75 },
      { name: 'Mar', amount: 180.25 },
      { name: 'Apr', amount: 120.00 },
      { name: 'May', amount: 620.30 },
      { name: 'Jun', amount: 250.00 },
      { name: 'Jul', amount: 180.50 },
      { name: 'Aug', amount: 350.75 },
      { name: 'Sep', amount: 200.25 },
      { name: 'Oct', amount: 300.00 },
      { name: 'Nov', amount: 400.50 },
      { name: 'Dec', amount: 150.00 },
    ];
    ...
    <div className="w-full h-full">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-blue-50 p-5 rounded-xl border border-blue-100 flex items-center">
          ...
          <div>
            ...
            <p className="text-xs text-blue-700 mt-1">Across all product categories</p>
          </div>
        </div>
        <div className="bg-green-50 p-5 rounded-xl border border-green-100 flex items-center">
          ...
          <div>
            ...
            <p className="text-xs text-green-700 mt-1">Across all time periods</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-xl border border-gray-100">
        <div className="mb-2 flex items-center justify-between">
          ...
          <div className="text-xs font-medium px-2 py-1 bg-blue-50 text-blue-600 rounded-full">Last 12 months</div>
        </div>
