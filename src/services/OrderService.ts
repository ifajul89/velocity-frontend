...
const orders: Order[] = [
  {
    ...
    timeline: [
      { date: "May 15, 2023", time: "10:30 AM", status: "Placed", completed: true },
      { date: "May 15, 2023", time: "2:45 PM", status: "Approved", completed: true },
      { date: "May 16, 2023", time: "9:15 AM", status: "Processed", completed: true },
      { date: "May 16, 2023", time: "5:30 PM", status: "Shipped", completed: true },
  ...
  },
  {
    ...
    timeline: [
      { date: "May 10, 2023", time: "3:20 PM", status: "Placed", completed: true },
      { date: "May 10, 2023", time: "5:45 PM", status: "Approved", completed: true },
      { date: "May 11, 2023", time: "10:15 AM", status: "Processed", completed: true },
      { date: "May 11, 2023", time: "4:30 PM", status: "Shipped", completed: true },
  ...
  },
  {
    ...
    timeline: [
      { date: "May 17, 2023", time: "9:15 AM", status: "Placed", completed: true },
      { date: "May 17, 2023", time: "11:30 AM", status: "Approved", completed: true },
      { date: "May 17, 2023", time: "4:45 PM", status: "Processed", completed: true },
      { date: "May 19, 2023", time: "10:00 AM", status: "Shipped", completed: false },
      { date: "May 21, 2023", time: "1:00 PM", status: "Delivered", completed: false }
    ],
  ...
  },
  {
    ...
    timeline: [
      { date: "May 18, 2023", time: "2:30 PM", status: "Placed", completed: true },
      { date: "Pending", time: "Pending", status: "Approved", completed: false },
      { date: "Pending", time: "Pending", status: "Processed", completed: false },
      { date: "Pending", time: "Pending", status: "Shipped", completed: false },
      { date: "Pending", time: "Pending", status: "Delivered", completed: false }
    ],
...
export const OrderService = {
  ...
  // Update order status
  updateOrderStatus: (id: string, status: string, estimatedDelivery?: string): Order | undefined => {
    ...
    orders[orderIndex] = {
      ...order,
      status,
      statusColor: statusColorMap[status] || "bg-gray-100 text-gray-800 border-gray-200",
      estimatedDelivery: estimatedDelivery || order.estimatedDelivery
    };

    // Update timeline based on status change
    const statusSteps = ["Placed", "Approved", "Processed", "Shipped", "Delivered"];
  ...
  updateEstimatedDelivery: (id: string, estimatedDelivery: string): Order | undefined => {
    const orderIndex = orders.findIndex(order => order.id === id);
