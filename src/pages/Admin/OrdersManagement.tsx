...
const statusOptions = [
    ...
    { value: "In Transit", label: "In Transit", color: "bg-indigo-100 text-indigo-800 border-indigo-200" },
...
export default function OrdersManagementPage() {
    ...
    const handleSearch = (e: React.FormEvent) => {
        ...
        if (searchQuery.trim()) {
            ...
            const filteredOrders = OrderService.getAllOrders().filter(order =>
    ...
    const handleEdit = (orderId: string, currentStatus: string, currentEstimatedDelivery: string) => {
    ...
    const handleDelete = (orderId: string) => {
        // Delete from service
        console.log(orderId)
        setOrders(OrderService.getAllOrders().filter(order => order.id !== orderId))
    }
            ...
            <SidebarInset>
                ...
                <div className="container mx-auto p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-muted-foreground">Manage order statuses and estimated delivery dates.</p>
                    </div>
                                        ...
                                        {orders.map((order) => (
                                            <TableRow key={order.id}>
                                                ...
                                                <TableCell>
                                                    ...
                                                    <div className="text-sm text-muted-foreground">{order.contactInfo.email}</div>
                                                </TableCell>
                                                <TableCell>{order.date}</TableCell>
                                                <TableCell>
                                                    {editingOrder === order.id ? (
                                                        <Select value={tempData.status} onValueChange={handleStatusChange}>
                                                ...
                                                <TableCell>
                                                    {editingOrder === order.id ? (
                                                        <div className="flex flex-col space-y-1">
                                                            <Label htmlFor={`est-delivery-${order.id}`} className="text-xs">Estimated Delivery:</Label>
                                                            <Input
